...
- A loading skeleton, empty-state messaging for zero-result filters, and summary stat cards (total denied amount, count, top reason) would be natural next steps for product polish but weren't required by the brief.
